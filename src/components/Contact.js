    ...
    <div className='flex flex-col mx-auto'>
      ...
      <div className='card w-96 glass p-4 my-4'>
        <p className='pb-4 indent-8 text-xl text-justify'>
          Thank you for your interest in contacting me. If you would like to
          contact me please reach out to me using any of the following channels
          below. I look foward to hearing from you!
        </p>
